/**
 * GitHub popuplar projects followers indexer. Based on list of popular repositories
 * finds all users who gave stars to these repositories.
 *
 * Usage:
 *   node followersIndexer.js ./repositories.json ./db/followers --tokens="A,B,C"
 *
 * Where:
 *   - repositories.json: file generated by repoIndexer.js
 *   - followers: leveldb name where to save found followers
 */
